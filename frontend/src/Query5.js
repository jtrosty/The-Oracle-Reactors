...
class Query5Manager extends React.Component {
	constructor() {
		super();
		this.state = {
			load: false,
	...
	componentDidUpdate()
	{
		...
		this.setState({ins: <Data5 chartType={this.state.chartType} attrFilters={attr} opFilters={op} valFilters={val} /> })
	}
  ...
  return (
	<div className="bodyContainer">
		...
		<div className="queryContainer">
			<h3>Description</h3>
			<p>The purpose of this query is to analyze what portion of accidents result in drivers receiving citations. Results are broken down by year and whether the citation was given in a school zone, in a construction zone, or on a regular road.</p>
			<h3>Chart</h3>
			<Query5Manager />
		</div>
	</div>
